...
3. Extract the binary file in same location and it should be named as 'GoogleNews-vectors-negative300.bin'
4. Open terminal and change the current working directory to Ans-Sent-Selection-Proj/code folder.
